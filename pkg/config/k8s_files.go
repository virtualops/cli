...
const NginxConfig = `apiVersion: v1
kind: ConfigMap
metadata:
  name: {{ .Release.Name }}-nginx
data:
...
const Ingress = `apiVersion: networking.k8s.io/v1beta1
kind: Ingress
metadata:
  name: {{ .Release.Name }}
  labels:
...
name: laravel
description: A Laravel chart for Kubernetes
...
const FPMConfigMap = `apiVersion: v1
kind: ConfigMap
metadata:
  name: {{ .Release.Name }}-fpm
data:
  www.conf: |
    ...
    ;listen = /var/run/php-fastcgi/fpm.sock // Defined in php-fpm.conf
